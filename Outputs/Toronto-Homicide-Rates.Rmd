...
Canada’s gun laws are strict and is federally controlled as owners requiring a permit to bear arms. Yet, homicide rates have been increasing in Toronto with shootings and gun violence as its leading cause [@open]. As a result, many Torontonians are becoming increasingly worried, especially after a record breaking number of 97 homicides in 2018 [@global]. Police Chief Mark Saunders believes that the spike in gun violence is attributed to the increase of street gang activity [@global]. Furthermore, he also believes that the growth in gang activity is due to increasing economic disparity [@npr]. Research has shown that most of Toronto’s gang activity is located in its lower income neighbourhoods [@npr].
...
```{r typerate, fig.cap="Homicide type cases in Toronto per year", echo=FALSE}
...
```{r neigh, fig.cap="Top six beighbourhoods with the largest culmulative homicide cases", echo=FALSE, fig.height=6, fig.width=8}
